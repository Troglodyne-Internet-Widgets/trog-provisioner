...
sub global_args {
    return (
        ...
        properties => {
            ...
            admin_user  => { type => 'string', description => 'The account that administers the guest.  An installation names it in the global section of ipmap.cfg, and nothing defaults it: a guest administered by root is not what anybody meant, and every recipe that sets ownership reads this.' },
